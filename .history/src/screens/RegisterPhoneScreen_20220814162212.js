...
const ResisterPhoneScreen = ({navigation}) => {
  const [selectedCountry, setSelectedCountry] = useState(CountryCode.find(country => country.name ="Korea"));
    ...
    <View style={styles.container}>
        ...
        <View style={styles.inputContianer}>
          ...
          <TouchableOpacity style={styles.countryListContainer}>
            <Image source={{uri: StaticImageService.getFlagIcon('KR')}} style={styles.flatIcon}/>
            <Text></Text>
            <MaterialIcons />
          </TouchableOpacity>
