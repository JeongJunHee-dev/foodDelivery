        ...
        <View style={styles.inputContianer} onLayout={({nativeEvent: {layout: {y},},}) => setInputsContainerY(y)}>
          ...
          <View style={styles.phoneInputContainer}>
            <TextInput placeholder="Phone Number" placeholderTextColor={Colors.DEFAULT_GREY}
                       ...
                       onFocus={() => setIsDropdownOpen(false)} style={styles.inputText} 
                       onChangeText={(text) => setPhoneNumber(selectedCountry)}/>
          </View>

        </View>

        <TouchableOpacity style={styles.signinButton} activeOpacity={0.8} onPress={() => navigation.navigate("Verification")}>
          <Text style={styles.signinButtonText}>Push to 버튼</Text>
        </TouchableOpacity>
