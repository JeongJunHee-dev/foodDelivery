...
const WelcomeScreen = () => {
    ...
    const viewConfigRef= useRef({viewAreaCoveragePercenrThreshold: 50});
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity activeOpacity={0.8} style={{marginLeft: 10}} onPress= {() => welcomeList.current.scrolltoIndex}>
