        ...
        <View style={styles.otpContainer}>
            ...
            <View style={styles.otpBox}>
                <TextInput style={styles.otpText} keyboardType="phone-pad" 
                            ...
                            onChangeText={ text => { setOtp({...otp, 3: text}); text ? thirdInput.current.focus() : firstInput.current.focus();}} />
            </View>
            <View style={styles.otpBox}>
                <TextInput style={styles.otpText} keyboardType="phone-pad" 
                            maxLength={1} ref={thirdInput} 
                            onChangeText={(text) => { text ? fourthInput.current.focus() : secondInput.current.focus();}} />
            </View>
            <View style={styles.otpBox}>
                <TextInput style={styles.otpText} keyboardType="phone-pad" 
                            maxLength={1} ref={fourthInput}
                            onChangeText={(text) => { !text && thirdInput.current.focus();}} />
            </View>
        </View>
